...
var AuthSigninComponent = /** @class */ (function () {
    function AuthSigninComponent(_userService) {
    ...
    AuthSigninComponent.prototype.login = function () {
        this._userService.login({ 'email': this.user.email, 'password': this.user.password });
    };
    AuthSigninComponent.prototype.refreshToken = function () {
        this._userService.refreshToken();
    };
    AuthSigninComponent.prototype.logout = function () {
