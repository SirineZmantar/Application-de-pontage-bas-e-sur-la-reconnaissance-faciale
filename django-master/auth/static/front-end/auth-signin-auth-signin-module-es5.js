...
var AuthSigninComponent = /** @class */ (function () {
    function AuthSigninComponent(UserService) {
    ...
    AuthSigninComponent.prototype.onLogin = function () {
        var _this = this;
        this.UserService.loginUser(this.login).subscribe(function (response) {
            console.log("hello");
            console.log(response);
            alert('welcome' + _this.login.email);
        }, function (error) {
