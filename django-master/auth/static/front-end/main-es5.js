...
var GestionComponent = /** @class */ (function () {
    ...
    GestionComponent.prototype.OnFileSelected = function (event) {
        console.log(event);
    };
    GestionComponent.prototype.ngOnInit = function () {
    };
    GestionComponent.prototype.addUser = function (e) {
        if (this.is != null) {
            this.update(this.tempEdit, e);
        }
        else {
            this.id += 1;
            var user1 = new src_app_demo_models_user_model__WEBPACK_IMPORTED_MODULE_2__["User"](e.id, e.image, e.lastname, e.firstname, e.email, e.tel, e.service, e.pwd); //e.date_e, e.date_s);
   ...
   */
    GestionComponent.prototype.update = function (model, e) {
        for (var i = 0; i < this.empl.length; ++i) {
    ...
    GestionComponent.prototype.deleteUser = function (d) {
        var index = this.empl.indexOf(d);
        this.empl.splice(index, 1);
    };
    GestionComponent.prototype.editUser = function (e, m) {
    ...
    GestionComponent.prototype.resetuser = function (e) {
        e.firstname = "";
        e.lastname = "";
        e.image = "";
        e.email = "";
...
var FileInputValueAccessor = /** @class */ (function () {
    ...
    FileInputValueAccessor.ctorParameters = function () { return [
...
var User = /** @class */ (function () {
    function User(id, image, lastname, firstname, email, tel, service, pwd) {
        this.id = id;
        this.image = image;
